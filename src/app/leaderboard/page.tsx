...
export default function LeaderboardPage() {
  ...
  return (
    <div className="">
      ...
      <h1 className="text-3xl font-semibold mb-6 text-foreground">Leaderboard </h1>
        ...
        {loading ? (
          ...
          <div className="bg-card text-card-foreground shadow-xl rounded-2xl overflow-hidden">
              ...
              <table className="w-full">
                ...
                <tbody>
                  {rewards.map((reward, index) => (
                    <tr key={reward.id} className={`${user && user.id === reward.userId ? 'bg-indigo-500/10' : ''} hover:bg-muted/50 transition-colors duration-150 ease-in-out`}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <div className="flex-shrink-0 h-10 w-10">
                            <User className="h-full w-full rounded-full bg-muted text-muted-foreground p-2" />
                          </div>
                          <div className="ml-4">
                            <div className="text-sm font-medium">{reward.userName}</div>
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          ...
                          <div className="text-sm font-semibold">{reward.points.toLocaleString()}</div>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
